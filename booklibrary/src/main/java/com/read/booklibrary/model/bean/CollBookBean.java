...
import com.read.booklibrary.model.gen.DaoSession;
...
public class CollBookBean implements Parcelable {
    ...
    public String getTitle() {
        return StringUtils.convertCC(title, bookApp.getContext());
    }
    ...
    public String getAuthor() {
        return StringUtils.convertCC(author, bookApp.getContext());
    }
    ...
    public String getShortIntro() {
        return StringUtils.convertCC(shortIntro, bookApp.getContext());
    }
    ...
    public String getCover() {
        return StringUtils.convertCC(cover, bookApp.getContext());
    }
    ...
    public String getUpdated() {
        return StringUtils.convertCC(updated, bookApp.getContext());
    }
    ...
    public String getLastChapter() {
        return StringUtils.convertCC(lastChapter, bookApp.getContext());
    }
    ...
    public String getLastRead() {
        return StringUtils.convertCC(lastRead, bookApp.getContext());
    }
